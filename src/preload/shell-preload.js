...
contextBridge.exposeInMainWorld('shellAPI', {
  ...
  printPreviewDocument: () => ipcRenderer.invoke(IPC.PBA_KIOSK_PRINT_PREVIEW),
  closePrintPreview: () => ipcRenderer.invoke(IPC.PBA_KIOSK_CLOSE_PREVIEW),
  ...
  setPrintPreviewMode: (mode) => ipcRenderer.invoke(IPC.CONFIG_SET_PRINT_PREVIEW_MODE, mode),
  renderLabelPreview: (payload) => ipcRenderer.invoke(IPC.LABEL_PREVIEW_RENDER, payload),
  ...
  setDefaultDevices: (defaults) => ipcRenderer.invoke(IPC.PRINTER_SET_DEFAULTS, defaults),
